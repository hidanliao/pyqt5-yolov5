...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/img/icon/图标2.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off) #窗口图标
...
"border-radius:0px;}")
        ...
        self.label_7.setStyleSheet("image: url(:/img/icon/图标2.ico);")
...
"     border: 0px ; \n"
"     border-image: url(:/img/icon/record.png);\n"
"     width:15px;\n"
